      ...
      <Container>
        <Box className={styles.content__wrapper}>
          <Box className={styles.section__head}>
            ...
            <Typography>Ship less than 100kg</Typography>
          </Box>
          ...
          <Box className={styles.form} component="form">
            <Box className={styles.input__group}>
              <Box className={styles.single__input}>
                ...
                <TextField placeholder="Enter source country" fullWidth />
                <br />
                <br />
                <Typography className={styles.input__label}>
                  Pickup Postcode*
                </Typography>
                <TextField placeholder="Enter pickup postcode" fullWidth />
              </Box>
              ...
              <Box className={styles.single__input}>
                ...
                <TextField placeholder="Enter Destination country" fullWidth />
                <br /> <br />
                <Typography className={styles.input__label}>
                  Destination Post*
                </Typography>
                <TextField placeholder="Enter Destination post" fullWidth />
              </Box>
            </Box>
